...
def arruma_arvore(root):
    ...
    labels = ['ID', 'var', 'lista_variaveis', 'dois_pontos', 'tipo',
                        ...
                        'operador_soma', 'lista_argumentos', 'VIRGULA',
                        'virgula', 'fator', 'cabecalho', 'FIM', 'lista_parametros', 'vazio', 'MAIS', 'chamada_funcao',
                        '(', ')', ':', ',', 'RETORNA', 'ESCREVA', 'SE', 'ENTAO', 'SENAO', 'MAIOR',
                        'MENOR', 'REPITA', 'IGUAL', 'MENOS', 'menor_igual', 'maior_igual', 'operador_logico',
                        'operador_multiplicacao', 'vezes', 'operador_relacional']
    ajusta_labels = [':=', '+', '*', '-', '/']
